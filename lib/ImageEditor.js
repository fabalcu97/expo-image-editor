...
function ImageEditorCore(props) {
    ...
    const [cropped, setCropped] = recoil_1.useRecoilState(Store_1.cropState);
    ...
    return (<>
      <react_native_1.StatusBar {...this.props.statusBarProps}/>
      <react_native_1.SafeAreaView style={{
        ...
        {ready ? (<react_native_1.View style={styles.container}>
            <ControlBar_1.ControlBar hasCropped={cropped} onPressBack={() => props.onCloseEditor()} onFinishEditing={() => onFinishEditing()}/>
